    ...
    <div class="container-card mb-5  mt-5">
      ...
      <div class="row-card">
        ...
        <div class="col-md-3">
          <div class="card mt-3">
            <div class="product-1 align-items-center p-2 text-center">
              <img src="assets/img/product7.jpg" class="rounded" alt="" width="150px">
              <h5>Laptop</h5>
              <div class="mt-3 info">
                <span class="text1 d-block">i7</span>
                <span class="text1"> Ram 8G</span>
              </div>
        ...
        <div class="col-md-3">
          <div class="card mt-3">
            <div class="product-1 align-items-center p-2 text-center">
              <img src="assets/img/product5.jpg" class="rounded" alt="" width="150px">
              <h5>Laptop</h5>
              <div class="mt-3 info">
                <span class="text1 d-block">i7</span>
                <span class="text1"> Ram 8G</span>
        ...
        <div class="col-md-3">
          <div class="card mt-3">
            <div class="product-1 align-items-center p-2 text-center">
              <img src="assets/img/product3.jpg" class="rounded" alt="" width="150px">
              <h5>Laptop</h5>
              <div class="mt-3 info">
                <span class="text1 d-block">i7</span>
                <span class="text1"> Ram 8G</span>
        ...
        <div class="col-md-3">
          <div class="card mt-3">
            <div class="product-1 align-items-center p-2 text-center">
              <img src="assets/img/product1.jpg" class="rounded" alt="" width="150px">
              <h5>Laptop</h5>
              <div class="mt-3 info">
                <span class="text1 d-block">i7</span>
                <span class="text1"> Ram 8G</span>
